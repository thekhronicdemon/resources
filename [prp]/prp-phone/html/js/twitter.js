...
$(document).on('click', '#send-tweet', function(e){
    ...
    if (TweetMessage != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-comments", "Chatterly", "Fill a message!", "#2f80ed");
    };
    $('#tweet-new-url').val("");
...
function CopyMentionTag(elem) {
    ...
    QB.Phone.Notifications.Add("fas fa-comments", "Chatterly", $(elem).data('mentiontag')+ " copied!", "#2f80ed", 1250);
