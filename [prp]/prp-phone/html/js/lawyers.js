            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        PRP.Phone.Notifications.Add("fas fa-phone", "Phone", "You are already connected to a call!");
                    }
                } else {
                    PRP.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is already in a call");
                }
            } else {
