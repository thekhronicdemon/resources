...
local function OpenTablet()
    ...
    TabletOpen = true
    SetNuiFocus(true, true)
    QBCore.Functions.TriggerCallback('qb-phone:server:GetTabletStatus', function(status)
        SendNUIMessage({
            action = 'openTablet',
...
RegisterNetEvent('qb-phone:client:UseTablet', function()
    TriggerEvent('prp-tablet:client:UseTablet')
end)

RegisterNetEvent('qb-phone:client:TabletMiningComplete', function(reward, message, activeMining)
...
RegisterNUICallback('GetCryptoShopItems', function(_, cb)
    QBCore.Functions.TriggerCallback('qb-phone:server:GetCryptoShopItems', function(items)
        cb(items or {})
    end)
end)

RegisterNUICallback('BuyCryptoShopItem', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-phone:server:BuyCryptoShopItem', function(resp)
        cb(resp or { success = false, message = 'Purchase failed.' })
    end, data.item)
end)

RegisterNUICallback('TabletStartCryptoMine', function(_, cb)
    QBCore.Functions.TriggerCallback('qb-phone:server:StartTabletCryptoMine', function(resp)
...
RegisterNUICallback('TabletOpenBusiness', function(_, cb)
    QBCore.Functions.TriggerCallback('qb-phone:server:GetBusinessControlData', function(resp)
...
RegisterNUICallback('BusinessHireClosest', function(_, cb)
    ...
    QBCore.Functions.TriggerCallback('qb-phone:server:BusinessHireClosest', function(resp)
...
RegisterNUICallback('BusinessFireMember', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('qb-phone:server:BusinessFireMember', function(resp)
...
RegisterNUICallback('GangHireClosest', function(_, cb)
    ...
    QBCore.Functions.TriggerCallback('qb-phone:server:GangHireClosest', function(resp)
        cb(resp or { success = false, message = 'Could not hire that player.' })
    end, targetId)
end)
...
RegisterNUICallback('GangFireClosest', function(_, cb)
    ...
    QBCore.Functions.TriggerCallback('qb-phone:server:GangFireClosest', function(resp)
