...
QBShared.Weapons = {
	...
	[`WEAPON_PISTOL_REDCAMO`]        = { name = 'weapon_pistol_redcamo', label = 'Pistol', weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in' },
	[`WEAPON_PISTOL_REDARMY`]        = { name = 'weapon_pistol_redarmy', label = 'Pistol', weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in' },
	[`WEAPON_PISTOL_BLUEARMY`]       = { name = 'weapon_pistol_bluearmy', label = 'Pistol', weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in' },
	[`WEAPON_PISTOL_YELLOWARMY`]     = { name = 'weapon_pistol_yellowarmy', label = 'Pistol', weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in' },
	[`WEAPON_PISTOL_GREENARMY`]      = { name = 'weapon_pistol_greenarmy', label = 'Pistol', weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in' },
	[`WEAPON_PISTOL_PURPARMY`]       = { name = 'weapon_pistol_purparmy', label = 'Pistol', weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in' },
