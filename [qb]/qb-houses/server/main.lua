...
RegisterNetEvent('qb-houses:server:openStash', function(CurrentHouse)
    ...
    if stashSlots and stashWeight then
        exports['prp-inventory']:OpenInventory(src, CurrentHouse, {
...
QBCore.Functions.CreateCallback('prp-phone:server:TransferCid', function(_, cb, NewCid, house)
...
QBCore.Functions.CreateCallback('prp-phone:server:GetPlayerHouses', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local MyHouses = {}
...
QBCore.Functions.CreateCallback('prp-phone:server:GetHouseKeys', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local MyKeys = {}
...
QBCore.Functions.CreateCallback('prp-phone:server:MeosGetPlayerHouses', function(_, cb, input)
    if input then
