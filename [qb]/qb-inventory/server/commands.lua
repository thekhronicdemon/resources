...
QBCore.Commands.Add('hotbar', 'Toggle Hotbar', {}, false, function(source)
    ...
    local quickslots = type(QBPlayer.PlayerData.metadata.quickslots) == 'table' and QBPlayer.PlayerData.metadata.quickslots or {}
    local hotbarItems = {}
    for i = 1, 4 do
        local itemSlot = tonumber(quickslots[tostring(i)] or quickslots[i])
        hotbarItems[i] = itemSlot and QBPlayer.PlayerData.items[itemSlot] or nil
    end
