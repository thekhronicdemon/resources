...
QBCore.Functions.CreateUseableItem('armor', function(source, item)
    TriggerClientEvent('consumables:client:UseArmor', source, item and item.slot)
end)

QBCore.Functions.CreateUseableItem('heavyarmor', function(source, item)
    TriggerClientEvent('consumables:client:UseHeavyArmor', source, item and item.slot)
end)

QBCore.Functions.CreateUseableItem('armor_plate', function(source, item)
    TriggerClientEvent('consumables:client:UseArmorPlate', source, item and item.slot)
end)
...
RegisterNetEvent('consumables:server:useHeavyArmor', function(slot)
    ...
    TriggerClientEvent('qb-inventory:client:ItemBox', src, QBCore.Shared.Items[result.itemName or 'heavyarmor'], 'remove')
    TriggerClientEvent('qb-inventory:client:updateInventory', src)
end)

RegisterNetEvent('consumables:server:useArmor', function(slot)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if not Player then return end
    local result = exports['prp-inventory']:EquipArmorItem(src, slot)
    ...
    TriggerClientEvent('qb-inventory:client:ItemBox', src, QBCore.Shared.Items[result.itemName or 'armor'], 'remove')
    TriggerClientEvent('qb-inventory:client:updateInventory', src)
end)

RegisterNetEvent('consumables:server:useArmorPlate', function(slot)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if not Player then return end
    ...
    TriggerClientEvent('qb-inventory:client:ItemBox', src, QBCore.Shared.Items[result.itemName or 'armor_plate'], 'remove')
    TriggerClientEvent('qb-inventory:client:updateInventory', src)
end)
