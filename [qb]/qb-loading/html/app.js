...
const load = Vue.createApp({
  setup () {
    return {
      ...
      CarouselSubText3: 'Photo captured by: TheKhronicDemon',
      CarouselText4: 'For additional support please join our community at discord.gg/Vt4R9pWg2Z',
      CarouselSubText4: 'Photo captured by: TheKhronicDemon',

      DownloadTitle: 'Downloading PRP Server',
      DownloadDesc: "Hold tight while we begin downloading all the resources/assets required to play on PRP Server. \n\nAfter download has been finished successfully, you'll be placed into the server and this screen will disappear. Please don't leave or turn off your PC. ",
